...
function patch.load()
  patch.layout = { -- elements are listed in draw order (lowest to highest)
    ...
    {path='patches/garage/acustic/CYCdh_LudSdStC-04.ogg',     type='block',    x= 0.458, y= 0.276, r= 0.45},
    ...
    {path='patches/garage/acustic/CyCdh_K3Tom-05.ogg',    type='membrane', x= 0.732, y= 0.107, r= 0.46},
    {path='patches/garage/acustic/CYCdh_Kurz01-Tom03.ogg',    type='membrane', x= 0.427, y=-0.352, r= 0.38},
    {path='patches/garage/acustic/CYCdh_Kurz03-Tom03.ogg',        type='membrane', x=-0.266, y=-0.341, r= 0.32},
    {path='patches/garage/acustic/CYCdh_VinylK1-Tamb.ogg',    type='block',    x= 0.867, y=-0.727, r= 0.40},
    {path='patches/garage/acustic/CYCdh_VinylK4-China.ogg',   type='cymbal',   x=-0.180, y=-0.758, r= 0.40},
    {path='patches/garage/acustic/CYCdh_TrashD-02.ogg',       type='cymbal',   x= 1.357, y=-0.161, r= 0.31},
    {path='patches/garage/acustic/CYCdh_K4-Trash10.ogg',      type='cymbal',   x=-0.883, y=-0.583, r= 0.42},
    {path='patches/garage/acustic/KHats_Open-07.ogg',         type='cymbal',   x= 1.253, y= 0.214, r= 0.36},
    {path='patches/garage/acustic/CYCdh_K2room_ClHat-05.ogg', type='cymbal',   x= 1.081, y=-0.474, r= 0.41},
    {path='patches/garage/acustic/CYCdh_K2room_ClHat-01.ogg', type='block',    x= 1.010, y=-0.625, r= 0.25},
    {path='patches/garage/acustic/CYCdh_VinylK4-Ride01.ogg',  type='cymbal',   x= 0.458, y=-0.711, r= 0.39},
    {path='patches/garage/acustic/CYCdh_Kurz01-Ride01.ogg',   type='block',    x= 0.458, y=-0.714, r= 0.17},
    {path='patches/garage/acustic/CyCdh_K3Crash-02.ogg',      type='cymbal',   x=-1.297, y=-0.003, r= 0.38},
