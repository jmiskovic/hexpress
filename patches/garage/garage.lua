...
function patch.load()
  patch.layout = { -- elements are listed in draw order (lowest to highest)
    ...
    {path='patches/garage/groovy/snare_quiet.ogg',  type='block',    pitchVariation=1.8,  x=-0.727, y= 0.065, r= 0.56},
    ...
    {path='patches/garage/groovy/mid_tom.ogg',      type='membrane', pitchVariation=0.8,  x= 0.344, y=-0.318, r= 0.34},
    {path='patches/garage/groovy/high_tom.ogg',     type='membrane', pitchVariation=0.8,  x=-0.312, y=-0.328, r= 0.32},
    {path='patches/garage/groovy/tamborine1.ogg',   type='block',    pitchVariation=0.5,  x= 1.448, y=-0.214, r= 0.39},
    {path='patches/garage/groovy/tamborine2.ogg',   type='block',    pitchVariation=0.5,  x= 0.945, y=-0.862, r= 0.51},
    {path='patches/garage/groovy/extra_splash.ogg', type='cymbal',   pitchVariation=0.1,  x=-0.117, y=-0.717, r= 0.31},
    {path='patches/garage/groovy/splash.ogg',       type='cymbal',   pitchVariation=0.1,  x=-1.146, y=-0.216, r= 0.35},
    {path='patches/garage/groovy/hat_open.ogg',     type='cymbal',   pitchVariation=0.05, x= 1.250, y= 0.078, r= 0.37},
    {path='patches/garage/groovy/hat_closed.ogg',   type='cymbal',   pitchVariation=0.5,  x= 1.003, y=-0.461, r= 0.43},
    {path='patches/garage/groovy/hat_quiet.ogg',    type='block',    pitchVariation=0.7,  x= 0.747, y=-0.620, r= 0.26},
    {path='patches/garage/groovy/ride.ogg',         type='cymbal',   pitchVariation=0.05, x= 0.487, y=-0.802, r= 0.39},
    {path='patches/garage/groovy/ride_bell.ogg',    type='block',    pitchVariation=0.1,  x= 0.482, y=-0.805, r= 0.17},
    {path='patches/garage/groovy/crash_1.ogg',      type='cymbal',   pitchVariation=0.05, x=-0.758, y=-0.646, r= 0.41},
